...
Environments.RegisterDevice("Generators Advanced", "Atmospheric Water Generator", "Atmospheric Water Generator Basic", "generator_water_tower", "models/Slyfo/moisture_condenser.mdl")
Environments.RegisterDevice("Generators Advanced", "Atmospheric Water Generator", "Atmospheric Water Generator", "generator_water_tower", "models/props_phx/life_support/rau_small.mdl")
